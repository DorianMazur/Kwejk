...
public class Top48Fragment extends Fragment implements ParserResponseInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        new HomePage(this).execute("https://kwejk.pl/top/48h");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        listView.setOnScrollListener(new EndlessScrollListener() {
            ...
            public void onLoadMore(int totalItemsCount) {
                new HomePage(Top48Fragment.this).execute("https://kwejk.pl/top/48h/strona/" + (maxPage - currentPage));
                currentPage++;
            }
        });
    }
