...
public class WaitingFragment extends Fragment implements ParserResponseInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        new HomePage(this).execute("https://kwejk.pl/oczekujace");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        HomeActivity.toolbar.setTitle(R.string.Waiting);
        ListView listView = (ListView) getView().findViewById(R.id.listView);
        listView.setOnScrollListener(new EndlessScrollListener() {
            @Override
            public void onLoadMore(int totalItemsCount) {
                if(maxPage > currentPage) {
                    new HomePage(WaitingFragment.this).execute("https://kwejk.pl/oczekujace/strona/" + (maxPage - currentPage));
                    currentPage++;
                }
            }
        });
