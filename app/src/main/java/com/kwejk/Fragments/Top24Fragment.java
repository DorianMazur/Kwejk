...
public class Top24Fragment extends Fragment implements ParserResponseInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        new HomePage(this).execute("https://kwejk.pl/top/24h");
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        HomeActivity.toolbar.setTitle("Najlepsze z 24h");
        ListView listView = (ListView) getView().findViewById(R.id.listView);
        listView.setOnScrollListener(new EndlessScrollListener() {
            @Override
            public void onLoadMore(int totalItemsCount) {
                new HomePage(Top24Fragment.this).execute("https://kwejk.pl/top/24h/strona/" + (maxPage - currentPage));
                currentPage++;
            }
        });
    }
